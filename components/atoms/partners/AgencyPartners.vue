<template>
  <svg width="160" height="161" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect
      x="116.802"
      y="29.437"
      width="19.139"
      height="121.021"
      rx="9.569"
      transform="rotate(45 116.802 29.437)"
      stroke="#BFBFC5"
      stroke-width="3"
    />
    <rect
    ...
    <rect
      ...
      height="78.608"
      rx="8.11"
      transform="rotate(-135 83.47 136.054)"
      stroke="#BFBFC5"
      stroke-width="3"
    />
    <rect
    ...
    <rect
      ...
      height="42.171"
      rx="6.164"
      transform="rotate(-135 112.235 140.054)"
      stroke="#BFBFC5"
      stroke-width="3"
    />
    <circle cx="80" cy="80.999" r="34" fill="#EDEDEE" />
    <path
