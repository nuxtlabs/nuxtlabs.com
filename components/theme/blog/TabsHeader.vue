  ...
  <div class="relative text-white rounded-t-lg d-code-group-header-bg">
    <div class="relative z-0 px-2">
      <button
        ...
        ref="tabs"
        :key="`${i}${label}`"
        class="relative px-3 py-1.5 xs:py-3 my-1.5 xs:my-0 text-sm font-mono font-medium tracking-tight focus:outline-none"
        :class="[
          activeTabIndex === i
      ...
      <span
        ...
        class="absolute -z-1 highlight-underline h-full xs:py-1.5"
      >
