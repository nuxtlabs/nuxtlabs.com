<template>
  <div>
    <img id="nuxtLogo" :src="`img/nuxt/nuxt-logo.svg`" class="absolute top-1/5 -left-28 opacity-0" />
    <img id="nuxtGradient" :src="`img/nuxt/gradient.svg`" class="absolute w-full left-0 right-0 -bottom-full" />
    <img id="gem1" :src="`img/nuxt/gem1.svg`" class="absolute -bottom-full left-1/4" />
