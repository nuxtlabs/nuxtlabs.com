  ...
  <div>
    <Ghost
      ...
      class="
        ...
        bottom-30
        -left-full
        lg:right-32 lg:left-auto lg:-bottom-full
        transform
        h-40
        w-40
        z-20
    ...
    <div
      ...
      class="
        ...
        right-0
        top-0
        lg:top-0 lg:bottom-12 lg:-left-10
        flex
        items-center
        opacity-0
        transform
...
.OldHomeDocusAnimations {
  &:hover {
    ~ div {
      ...
      #ghost {
        animation: ghostAnimMobileIn 1s forwards cubic-bezier(0.83, 0, 0.17, 1),
          ghostFloatX 15s infinite alternate linear;
        @screen lg {
          animation: ghostAnimDesktopIn 1s forwards
  ...
  ~ div {
    ...
    #ghost {
      ...
      @screen lg {
        animation: ghostAnimDesktopOut 1s forwards
          cubic-bezier(0.83, 0, 0.17, 1);
      }
    }
  }
